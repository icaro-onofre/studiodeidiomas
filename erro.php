...
<body>
	...
	<div id="page" class="container"> 
		...
		<!--BEGIN MAIN SECTION -->
		<div class="section team" id="aluno">
			<div class="container">
				<section class="main">
					
					<div class="header">
						<h2 class="c-font-80 mbot5 pbot20 ptop20 align-center btop1 bbot1">ERRO</h2> 
					</div>
					
					<div class="clear pbot30"></div>
					
					<div class="column">
						<h3>Ocorreu algum erro no site. Por favor, tente novamante.</h3>
					</div>  
